			...
			Conditions: status.Conditions{
				{
					...
					LastTransitionTime: metav1.Time{time.Date(2021, 1, 1, 12, 30, 30, 100, time.UTC)},
				},
				{
					Type:               "Error",
					Status:             "True",
		...
		syncTarget := ClusterLogForwarderStatus{
			Conditions: status.Conditions{
				// We expect Ready to be updated to True and have the current timestamp.
				{
					...
					LastTransitionTime: metav1.Time{time.Date(2023, 1, 1, 12, 30, 30, 100, time.UTC)},
				},
				...
				"name1": {
					{
						...
						LastTransitionTime: metav1.Time{time.Date(2024, 1, 1, 12, 30, 30, 100, time.UTC)},
					},
					{
						Type:               "Available",
						Status:             "True",
			...
			Conditions: status.Conditions{
				{
					...
					Reason:             "Operator is ready",
					Message:            "Operator is ready",
					LastTransitionTime: metav1.Time{time.Date(0, 0, 0, 0, 0, 0, 0, time.UTC)},
				},
				{
					Type:               "Foo",
					Status:             "Foo",
